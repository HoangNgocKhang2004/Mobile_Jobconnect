      ...
      child: Column(
        children: [
          Row(
            children: [
              Expanded(
                child: _buildInputField("Họ", Icons.person_outline),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: _buildInputField("Tên", Icons.person_outline),
              ),
            ],
          ),
          const SizedBox(height: 16),
          ...
          _buildSectionItem(
            ...
            [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildInputField("Bắt đầu", Icons.calendar_today_outlined),
                  ),
                  const SizedBox(width: 16),
                  Expanded(
                    child: _buildInputField("Kết thúc", Icons.calendar_today_outlined),
                  ),
                ],
              ),
              const SizedBox(height: 16),
