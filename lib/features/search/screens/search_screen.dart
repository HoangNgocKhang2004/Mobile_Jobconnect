            ...
            MaterialPageRoute(
              builder:
                  (context) => JobDetailScreen(
                    ...
                    companyLogo: "",
                    description:
                        "Miêu tả công việc chi tiết sẽ được hiển thị ở đây...",
                    requirements:
                        "Yêu cầu công việc chi tiết sẽ được hiển thị ở đây...",
                    salary: job['salary'],
                    location: job['location'],
                    employmentType: job['type'],
                    experience: "1-3 năm",
                    postedDate: job['postedDate'],
                    applicantsCount: (20 + (job['title'].length % 10)).toInt(),
                  ),
            ),
          );
        },
